...
SystemType=$(arch)
downLoadPath="https://raw.githubusercontent.com/handy-golang/shell-hooks-package/main/shell-hooks_x86_64"

if [[ ${SystemType} =~ "aarch64" ]]; then
  downLoadPath="https://raw.githubusercontent.com/handy-golang/shell-hooks-package/main/shell-hooks_aarch64"
fi
